...
class EditDataWidgetModule extends StatefulWidget {
  const EditDataWidgetModule({Key? key, required this.courses}) : super(key: key);

  final Courses courses;
  @override
  State<EditDataWidgetModule> createState() => _EditDataWidgetModuleState();
}

class _EditDataWidgetModuleState extends State<EditDataWidgetModule> {
