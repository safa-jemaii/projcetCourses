 ...
 Future<void> _pickImage(ImageSource source) async {
   ...
   List<Step>stepList()=>[
    Step(
      ...
      title: Text('General informations for courses'),
    content: Column(
      children: <Widget>[
        Column(
 ...
 TextFormField(
  ...
  validator: (value) {
    if (value == null || value.isEmpty) {
      return 'Please enter the Cours name !';
    }
    return null;
  },
),
  ...
  children: [
    ...
    border: OutlineInputBorder( // définir une bordure de rectangle
      ...
      borderSide: BorderSide.none, // supprimer la bordure de ligne
        ...
        validator: (value) {
          if (value == null || value.isEmpty) {
            return 'Please enter the Cours description';
          }
          return null;
        },
      ),
...
if(pickedDate!=null){
 ...
 TextFormField(
  ...
  decoration: InputDecoration(
    hintText: "Enter the course's duration",
    hintStyle: TextStyle(
      color: Colors.grey[500],
      fontSize: 14,
    ),
